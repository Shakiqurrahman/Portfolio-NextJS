    ...
    <section className="mt-20 flex gap-20">
      ...
      <div>
        ...
        <div className="mt-10">
          ...
          <p className="text-[#707070] font-semibold mb-1">2022 - Present</p>
          ...
          <p className="text-base text-[#c2c2c2] text-justify mb-6 leading-7">
            ...
            stack since 2022. I design and implement backend
            architectures using Node.js and Express.js, create responsive user
            interfaces with React, and manage databases with MongoDB.
          </p>
          <p className="text-base text-[#c2c2c2] text-justify mb-6 leading-7">
        ...
        <div className="mt-10">
          ...
          <p className="text-[#707070] font-semibold mb-1">2020 - Present</p>
          <h5 className="text-xl font-medium mb-1 text-[#4a61c3]">
            Diploma In CSE
          </h5>
          <p className="text-[15px] text-[#898989] mb-4">
          ...
          <p className="text-base text-[#c2c2c2] text-justify mb-6 leading-7">
            In 2020, I started diploma in Computer Science & Engineering (CSE)
            at Sylhet Polytechnic Institute. I am currently continuing my
        ...
        <div className="mt-10 text-[#d3d3d3]">
          ...
          <div className="grid grid-cols-2 gap-y-6">
            <div>
              <p className="text-[#898989] font-semibold mb-1">92%</p>
            ...
            <div>
              <p className="text-[#898989] font-semibold mb-1">80%</p>
            ...
            <div>
              <p className="text-[#898989] font-semibold mb-1">85%</p>
            ...
            <div>
              <p className="text-[#707070] font-semibold mb-1">82%</p>
