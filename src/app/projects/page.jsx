...
import Image3 from "@/../public/assets/Little Rabbit Mockup.jpg";
        ...
        <div className="flex-1 bg-[#202020] p-4 pb-6 rounded-[30px]">
          ...
          <div className="flex justify-between items-center   mx-2">
            ...
            <span className="flex gap-6 items-center  ">
              ...
              <Link href="https://shofy-ecommerce.netlify.app/" target="_blank">
                <FaExternalLinkAlt className="text-[23px] opacity-70 hover:opacity-100 duration-300" />
              </Link>
            </span>
          </div>
          ...
          <div className="bg-[#202020] p-4 pb-6 rounded-[30px]">
            ...
            <div className="flex justify-between items-center  mx-2">
              <div>
                ...
                <h1 className="text-[22px] opacity-90 font-medium">Hoobank</h1>
              </div>
              <span className="flex gap-6 items-center  ">
                <Link
